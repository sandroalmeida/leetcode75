...
public class BestTimeBuySellStock_V2 {
    ...
    public static int maxProfit(int[] prices) {
        ...
        for (int price : prices) {
            if (price < bestValueBuy) {
                bestValueBuy = price;
            } else if (price - bestValueBuy > maxProfit) {
                maxProfit = price - bestValueBuy;
            }
        }
        return maxProfit;
    }
    ...
    public static void main(String[] args) {
        ...
        int[] prices_4 = new int[]{ 2, 1, 2, 0, 1 };
